...
const MILESTONES = [
  {
    ...
    description:
      "Vortex Lmntirx began with a small fleet of executive sedans, built on a vision to elevate the standard of luxury ground transportation.",
  },
  {
    year: "2012",
  ...
  },
  {
    ...
    description:
      "Vortex Lmntirx now operates in more than 50 cities across the United States, serving clients coast to coast with consistent excellence.",
  },
] as const;
...
const LEADERSHIP = [
  {
    ...
    bio: "A hospitality professional with over 15 years of experience, Alexander founded Vortex Lmntirx with a mission to redefine premium ground transportation through consistency and care.",
  },
  {
    name: "Victoria Chen",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Vortex Lmntirx started with a simple goal — to make luxury
